...
PhysicalLayer::PhysicalLayer(int layerid, bool hasweight, bool istrans, int weightsizerow, int weightsizecol, string nonlinearfunc, list<int> inputlayerid, list<int> outputlayerid, CoreRange thecores){
    layer_id = layerid;
